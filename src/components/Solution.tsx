import { QrCode, MapPin, BarChart3, BookOpen } from 'lucide-react';
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">
                            ...
                            <span className="text-blue-600">Attendance & Academics</span>
                        </h2>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl p-2 border border-gray-100">
                            <div className="bg-slate-50 rounded-xl overflow-hidden aspect-[4/3] flex items-center justify-center relative">
                                ...
                                <div className="relative z-10 text-center">
                                    <div className="w-20 h-20 bg-blue-100 text-blue-600 rounded-2xl mx-auto flex items-center justify-center mb-4">
                                ...
                                <div className="absolute top-12 right-4 w-1/2 h-32 bg-blue-50 rounded-lg opacity-80 border border-blue-100"></div>
                                <div className="absolute bottom-4 left-4 right-4 h-24 bg-white rounded-lg opacity-70"></div>
                            </div>
                        </div>

                        {/* Decorative dots */}
                        <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-blue-600/5 rounded-full blur-3xl -z-10"></div>
