    ...
    return (
        <section className="py-20">
            <div className="max-w-5xl mx-auto px-6">
                <div className="bg-gradient-to-r from-primary-700 to-primary-600 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
                    ...
                    <p className="text-lg text-primary-100 mb-10 max-w-2xl mx-auto relative z-10">
                        Join 500+ institutions using EduTrace to save time, eliminate proxies, and improve academic outcomes.
                    </p>

                    <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
                        <button className="bg-white text-primary-700 px-8 py-4 rounded-xl font-bold hover:bg-gray-50 transition-colors shadow-lg">
                            Start Free Trial
                        </button>
